...
cap = cv2.VideoCapture(r'D:\Pesa\Video\test\U.mp4')
size = (int(cap.get(3)),int(cap.get(4)))
resultss = cv2.VideoWriter("Stabili_vidstab_AI.mp4", 
...
with mp_pose.Pose(
  ...
  while cap.isOpened():
    ...
    image = stabilizer.stabilize_frame(input_frame=image,layer_func=layer_blend)
