...
cap = cv2.VideoCapture(r'D:\projectF\Mediapipe\walking\walking_7.mp4')
# cap = cv2.VideoCapture(0)

# name_Video = input('Enter Video name:')
name_Video = "walking_7"
size = (int(cap.get(3)), int(cap.get(4)))
result = cv2.VideoWriter(str(name_Video)+"_line.avi", 
